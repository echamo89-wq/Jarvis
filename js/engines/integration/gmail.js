...
export const gmailIntegration = {
  ...
  description: 'Correo electrónico Gmail: leer bandeja de entrada, enviar, buscar y leer correos.',
  guideSteps: [
    '1. ANDÁ a https://console.cloud.google.com — Iniciá sesión con tu cuenta de Google.',
    '2. CREÁ UN PROYECTO: Arriba a la izquierda, selector de proyectos → "NUEVO PROYECTO". Ponele un nombre (ej: "Jarvis Gmail").',
    '3. HABILITÁ LA API: Andá a "APIs y Servicios" → "Biblioteca". Buscá "Gmail API" → click → Habilitar.',
    ...
    '6. ANOTAR: Copiá el Client ID y Client Secret que aparecen. Pegalos abajo y dale a "Conectar con Google".'
  ],
