...
export const googleCalendarIntegration = {
  ...
  description: 'Lee y crea eventos en tu agenda de Google Calendar.',
  guideSteps: [
    '1. ANDÁ a https://console.cloud.google.com — Iniciá sesión con tu cuenta de Google.',
    '2. CREÁ UN PROYECTO: Arriba a la izquierda, selector de proyectos → "NUEVO PROYECTO". Ponele un nombre (ej: "Jarvis Calendar").',
    '3. HABILITÁ LA API: Andá a "APIs y Servicios" → "Biblioteca". Buscá "Google Calendar API" → click → Habilitar.',
    ...
    '6. ANOTAR: Copiá el Client ID y Client Secret. Pegalos abajo y dale a "Conectar con Google Calendar".'
  ],
