...
export function _separateThinkingAndResponse(text) {
  ...
  const REASONING_PATTERNS = [
    ...
    /^(I'm going|I will|I'll|I need|I should|let me|my plan is|I think|I believe|I'd like)/i,
    /^(analyzing|determining|the user|i understand|i'm about|let's|first|second|finally|next)/i,
    /^(to (respond|answer|get|find|check|verify|determine|look))/i,
    /^(the user|the question|the request|the query).*(has |is |wants |asks |says)/i,
    /\b(tool result|function response|json data|api call|fetching|searching)\b/i,
  ...
  for (const sent of sentences) {
    ...
    if (isReasoning) thinkingParts.push(s);
